...
void main() {
  group('M3E Bridge', () {
    test('buildM3EThemeData builds M3EThemeData matching Flutter ThemeData', () {
      final theme = ThemeData.light();
      final m3eThemeData = buildM3EThemeData(theme);

      expect(m3eThemeData.colorScheme.primary, equals(theme.colorScheme.primary));
      expect(m3eThemeData.brightness, equals(theme.brightness));
    });

    testWidgets('m3eThemeBridgeBuilder memoizes M3EThemeData when theme does not change', (tester) async {
    ...
    testWidgets('m3eThemeBridgeBuilder updates M3EThemeData when theme changes', (tester) async {
